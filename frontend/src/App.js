...
// Images
const IMAGES = {
  logo: "https://customer-assets.emergentagent.com/job_github-export-6/artifacts/0qa41gui_TFHS%20Logo.png",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center mb-6">
            <div className="relative">
              <div className="bg-amber-500 text-white px-5 py-1.5 rounded-full text-sm font-medium tracking-wider flex items-center gap-2 shadow-lg">
                <Award size={16} />
                15+ Years of Trusted Service
              </div>
              {/* Ribbon tails */}
              <div className="absolute -left-1.5 top-1/2 -translate-y-1/2 w-3 h-3 bg-amber-600 transform rotate-45 -z-10"></div>
              <div className="absolute -right-1.5 top-1/2 -translate-y-1/2 w-3 h-3 bg-amber-600 transform rotate-45 -z-10"></div>
            </div>
          </div>
...
const Gallery = () => {
  ...
  const galleryImages = [
    ...
    { image: "https://customer-assets.emergentagent.com/job_github-export-6/artifacts/gp0pbevl_1772653909180.png", title: "Basement Kitchenette & Laundry", category: "Kitchen" },
    // Bathroom
    ...
    // Basement
    { image: "https://customer-assets.emergentagent.com/job_github-export-6/artifacts/ha12ms9u_Screenshot_20260301_222540_Chrome.jpg", title: "Basement Flood Restoration - After", category: "Basement" },
    ...
    { image: "https://customer-assets.emergentagent.com/job_github-export-6/artifacts/gp0pbevl_1772653909180.png", title: "Basement Kitchenette & Laundry Complete", category: "Basement" },
    ...
    { image: "https://customer-assets.emergentagent.com/job_github-export-6/artifacts/o2yogm51_1771625821760.png", title: "Retaining Wall with Landscaping - After", category: "Roofing & Exterior" },
